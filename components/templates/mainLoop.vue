						...
						<v-col class="col-xs-12 col-md-4" v-for="card in cards" :key="card.title">
							<v-card class="mx-auto" max-width="344">
								...
								<v-card-title class="font-podkova-bold">
									{{ card.title }}
									<v-spacer></v-spacer>
									<v-btn class="font-podkova-bold deep-orange darken-2" color="deep-orange darken-2" :to="card.link">
										More
									</v-btn>
								</v-card-title>
							</v-card>
	...
	data() {
		return {
			cards: [
				{
					title: 'Static Pages',
					thumbnail: 'https://admin.onlinecasino.ua/img/static_page.png',
					link: '/admin/static-pages'
				},
				{ title: 'Casino', thumbnail: 'https://admin.onlinecasino.ua/img/casino.png', link: '/admin/casino' },
				{ title: 'Payment', thumbnail: 'https://admin.onlinecasino.ua/img/blog.png', link: '/admin/payment' },
				{ title: 'Games', thumbnail: 'https://admin.onlinecasino.ua/img/slots.png', link: '/admin/game' },
				{ title: 'News', thumbnail: 'https://admin.onlinecasino.ua/img/slots.png', link: '/admin/news' },
