        ...
        <v-row>
            <v-col class="mt-0">
                ...
                <MM_Multiple_Two_Input  
                    :value = 'data.slot_category'
                    :action = 'action' 
                    title = "Slot Category" 
                    action_key = "slot_category"
                />
                <MM_Multiple_Two_Input  
                ...
                />
                <MM_Multiple_Two_Input  
                    :value = 'data.payment_out_methods'
                    :action = 'action' 
                    title = "Payment out methods" 
                    action_key = "payment_out_methods"
                />
                ...
                />
                <MM_Multiple_Input 
                    :value = 'data.active_languages'
                    :action = 'action' 
                    title = "Languages" 
                    action_key = "active_languages"
                />
                <MM_Rating 
                    :value = 'data.convenience'
                    :action = 'action' 
                    title = "Convenience" 
                    action_key = "convenience"
                />
                <MM_Rating 
                    :value = 'data.replenishment'
                    :action = 'action' 
                    title = "Replenishment" 
                    action_key = "replenishment"
                />
                <MM_Rating 
                    :value = 'data.support'
                    :action = 'action' 
...
<script>
    ...
    import MM_Multiple_Options from '~/components/lib/MM_Multiple_Options'
    import MM_Multiple_Two_Input_Text_Image from '~/components/lib/MM_Multiple_Two_Input_Text_Image'
    import MM_Multiple_Options_Three_Input from '~/components/lib/MM_Multiple_Options_Three_Input'
    import MM_Multiple_Select_Three_Input from '~/components/lib/MM_Multiple_Select_Three_Input'
    import config from '~/config'
    export default {
        name: "casinoMeta",
        props: ['data', 'action'],
        components: {MM_Multiple_Input_Text, MM_Input, MM_Rating, MM_Multiple_Input, 
        MM_Checkbox, MM_Multiple_Two_Input, MM_Review, MM_Multiple_Options, MM_Multiple_Two_Input_Text_Image, MM_Multiple_Options_Three_Input, MM_Multiple_Select_Three_Input},
        data() {
            return {
