<template>
	<v-container>
		<v-card>
			<v-toolbar flat color="deep-orange darken-2" dark>
					...
					<v-card flat>
						<v-container>
							...
							>
								...
								<v-col class="col-3 text-right">
									<v-menu transition="slide-y-transition" bottom class="d-block">
										...
										<v-list>
											<v-list-item class="font-podkova-bold pointer">
							...
							<v-row>
								<v-col>
									<v-btn class="deep-orange darken-2 font-weight-bold ml-1" @click="onAddCategory('casino')">
		...
		<v-dialog v-model="dialog" width="500">
			<v-card>
				...
				<v-card-text>
					<p class="headline  font-weight-bold mt-5">{{ deleteItem.category_name }} will be delete!!!!</p>
				</v-card-text>
				...
				<v-card-actions>
					<v-spacer></v-spacer>
					<v-btn class="deep-orange darken-2 font-podkova-bold" text @click="onAcceptDelete">
						Accept
					</v-btn>
					<v-btn class="error font-podkova-bold" text @click="onCancel">
						Cancel
					</v-btn>
				</v-card-actions>
			</v-card>
		...
		<v-dialog v-model="addDialog" width="500">
			<v-card>
				...
				<v-card-actions>
					<v-spacer></v-spacer>
					<v-btn class="font-podkova-bold deep-orange darken-2" text @click="onAcceptAdd">
						Add
					</v-btn>
					<v-btn class="error font-podkova-bold" text @click="onCancelAdd">
						Cancel
					</v-btn>
				</v-card-actions>
			</v-card>
		...
		<v-dialog v-model="editDialog" width="500">
			<v-card>
				...
				<v-card-actions>
					<v-spacer></v-spacer>
					<v-btn class="font-podkova-bold deep-orange darken-2" text @click="onAcceptEdit">
						Accept
					</v-btn>
					<v-btn class="error font-podkova-bold" text @click="onCancelEdit">
						Cancel
					</v-btn>
				</v-card-actions>
			</v-card>
