			...
			<v-row>
				<v-col class="mt-0">
					...
					<MM_Multiple_Two_Input_Image
						v-if="data.editor === 'two_input_image'"
						:value="data.value"
						:title="data.title"
						:action="action"
						action_key="value"
					...
					<MM_Multiple_Input_Text
						v-if="data.editor === 'multiple_input_text'"
						:value="data.value"
						:title="data.title"
						:action="action"
						action_key="value"
					/>
					<MM_Multiple_Menu
						v-if="data.editor === 'multiple_menu'"
						:value="data.value"
						:title="data.title"
						:action="action"
						action_key="value"
