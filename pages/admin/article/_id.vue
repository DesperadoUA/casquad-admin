<template>
	<div>
		...
		<relative v-if="data.body" :data="data.body" :action="POST_TYPE + '/changeStateCurrentPost'" postType="ARTICLE" />
		<v-container>
			<v-row>
		...
		<postPreview v-if="data.body" slug="article" :permalink="data.body.permalink" />
		<confirmDelete v-if="confirmDeleteIsShow" @delete="confirmDelete" @cancel="cancel" />
	</div>
</template>

<script>
import postMeta from '~/components/templates/meta/Article'
