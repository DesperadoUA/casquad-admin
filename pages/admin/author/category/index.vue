		...
		<v-container class="container--fluid">
			<v-row>
				<v-col class="offset-1 col-10 mt-10">
					<h1 class="page_title font-podkova-bold">Author category</h1>
				</v-col>
			</v-row>
			<v-row>
								...
								<v-card>
									<v-card-text class="black">
										<div v-if="tab == 'tab-2'">
											...
											<MM_Paginations
												:length="Math.ceil(data.ua.total / numnerPostOnPage)"
												:lang="2"
										...
										<div v-else>
											...
											<MM_Paginations
												:length="Math.ceil(data.ru.total / numnerPostOnPage)"
												:lang="1"
												:action="POST_TYPE + '/setPaginationPage'"
												:numberOnPage="numnerPostOnPage"
												:getterPage="POST_TYPE + '/getPage'"
...
export default {
	...
	data() {
		return {
			...
			POST_DB: 'author_category',
			data: {
				ru: {
					post_slug: 'author/category',
					lang: 'ru',
					posts: [],
					total: 0
				},
